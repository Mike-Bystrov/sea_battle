...
public class Field {
    ...
    public static void generateShipsForComputer() {
        // представить каждую клетку числом от 0 до 99
        // начальную клетку выбрать рандомно, потом рандомно выбрать направление
        // проверить, чтобы всё было ок
        // в след раз не рассматривать числа, которые не подходят
        // повторять, пока не расставятся все корабли
    }
}